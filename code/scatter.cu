...
//A method that will compute launch parameters and launch the
//above kernel.
...
//A kernel that takes in scatter_indices and resorts the financial options
//into an output array. This will be used in the compact methods, where
//compact will computed the scatter_indices and call this method.
                                       ...
                                       real *d_option_years_result)
{
  ...
  for(; i < n; i += grid_size)
  {
    ...
    //If the options meet thresholds, put it in the result arrays. 
...
//Computed the launch parameters and calls the above kernel.
