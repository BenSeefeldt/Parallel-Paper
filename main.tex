...
\done\todo{position}
    ...
    \begin{figure}
    \centering
    \includegraphics[scale=.85]{bitsort}
    \caption{A simple pair-wise summation.}
    \end{figure}
